...
describe('comparison blog Android availability', () => {
  it.each(['meetup', 'gaffl', 'travello', 'hostelworld'])('keeps the %s comparison consistent with shipped Android availability', (competitor) => {
    ...
    expect(copy.includes("Android version is in development")).toBe(false);
