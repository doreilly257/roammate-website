...
const CITY_GUIDE_SLUGS_LIST = [
  ...
  "kandy","kathmandu","kigali","knysna","koh-lanta","kolkata","kota-kinabalu","krakow","kratie","ksamil",
  ...
  "nong-khiaw","nuwara-eliya","oaxaca","orlando","osaka","oslo","otavalo","pakse","palma-de-mallorca","panama-city",
  ...
  "san-francisco","san-pedro-de-atacama","santiago","sao-paulo","sapa","sapporo","savannakhet","seoul",
